...
crudini --set /etc/keystone/keystone.conf DEFAULT admin_token password
crudini --set /etc/keystone/keystone.conf database connection mysql://keystone:password@$CONTROLLER_IP/keystone
...
crudini --set /etc/glance/glance-api.conf database connection mysql://glance:password@$CONTROLLER_IP/glance
...
crudini --set /etc/glance/glance-registry.conf database connection mysql://glance:password@$CONTROLLER_IP/glance
...
crudini --set /etc/nova/nova.conf database connection mysql://nova:password@$CONTROLLER_IP/nova
...
crudini --set /etc/neutron/neutron.conf database connection mysql://neutron:password@$CONTROLLER_IP/neutron
